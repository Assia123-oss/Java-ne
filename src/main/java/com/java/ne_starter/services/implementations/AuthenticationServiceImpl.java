...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> register(RegisterDto registerDto) {
        try {
            ...
            createUserDTO.setFirstName(registerDto.getFirstName());
            createUserDTO.setLastName(registerDto.getLastName());
            createUserDTO.setEmail(registerDto.getEmail());
            createUserDTO.setUsername(registerDto.getUsername());
            createUserDTO.setPassword(registerDto.getPassword());
            createUserDTO.setNationalId(registerDto.getNationalId());
            createUserDTO.setPhoneNumber(registerDto.getPhoneNumber());
            createUserDTO.setRole(registerDto.getRole().name());
